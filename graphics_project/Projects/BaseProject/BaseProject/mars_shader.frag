...
// camera modes 0,1,2,6 we want the light to rotate w/ modelview matrix
vec3 light_position = (CameraMode != 6 && CameraMode != 2 && CameraMode != 1 && CameraMode != 0) ? vec3((modelview_matrix) * vec4(200, 50.0, -100.0, 1)) : vec3(200, 50.0, 200.0);
